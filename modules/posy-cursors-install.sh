...
sudo cp -rp "$HOME"/posy-cursors/themes/posy-white /usr/share/icons/posy-cursors
sudo cp -rp "$HOME"/posy-cursors/themes/posy-black /usr/share/icons/posy-cursors-black
